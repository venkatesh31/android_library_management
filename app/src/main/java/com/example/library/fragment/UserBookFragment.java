...
public class UserBookFragment extends Fragment {
    ...
    private static final String TAG = UserBookFragment.class.getName();
    ...
    public void onResume() {
        super.onResume();
        UserApiCall.getUserBook(LibraryUtils.loginedUser.getUserId(), EStatus.ACTIVE.getCode(),getActivity());
    }
